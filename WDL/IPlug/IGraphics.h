...
public:
  ...
  bool DrawScaledBitmap(IBitmap* pBitmap, IRECT* pDest, int srcX, int srcY, const IChannelBlend* pBlend = 0);
  ...
  void SetParameterDefaultFromPlug(int paramIdx, double value, bool normalized);
  ...
  void SetControlDefaultFromPlug(int controlIdx, double normalizedValue);
